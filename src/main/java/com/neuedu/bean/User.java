...
public class User {
    ...
    public User(Integer uid, String uname, String upwd, String usex, String ubirthday, String receiver, String raddress, String rtelephone, Integer rlevel, String raids, Integer ifdelete, String uemail, String uphone) {
        this.uid = uid;
        this.uname = uname;
        this.upwd = upwd;
        this.usex = usex;
    ...
    public User(String uname, String usex, String ubirthday, String receiver, String raddress, String rtelephone) {
        this.uname = uname;
        this.usex = usex;
        this.ubirthday = ubirthday;
        this.receiver = receiver;
    ...
    public User(Integer uid, String uname, String upwd, String usex, String ubirthday, String receiver, String raddress, String rtelephone, Integer rlevel, String raids, Integer ifdelete) {
        this.uid = uid;
        this.uname = uname;
        this.upwd = upwd;
        this.usex = usex;

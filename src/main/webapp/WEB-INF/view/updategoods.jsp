    ...
    <div class="content">
        ...
        <div class="hbody">
            <div class="container">
                ...
                <div class="row">
                    <form class="form-horizontal" action="/goods/updategoods" method="post" enctype="multipart/form-data">
                            ...
                            <div class=" form-group col-sm-6">
                                <select class="form-control" name="cid" id="cid">
                                   <c:forEach items="${type}" var="type">
                                       <option value="${type.tid}" <c:if test="${goods.cid==type.tid}">selected</c:if>>${type.tname}</option>
                                   </c:forEach>
                                </select>
                            </div>
                        </div>
